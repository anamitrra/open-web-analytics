 ...
 */
 ...
 if (!defined('OWA_DTD_VARCHAR255')) {
    define('OWA_DTD_VARCHAR255', 'VARCHAR(255)'); // or the appropriate SQL data type
}
// Define missing constants if they are not already defined
if (!defined('OWA_DTD_BIGINT')) {
    define('OWA_DTD_BIGINT', 'BIGINT'); // Adjust as needed
}
if (!defined('OWA_DTD_BLOB')) {
    define('OWA_DTD_BLOB', 'BLOB'); // Adjust as needed
}
if (!defined('OWA_DTD_INT')) {
    define('OWA_DTD_INT', 'INT'); // Adjust as needed
}
if (!defined('OWA_DTD_TINYINT2')) {
    define('OWA_DTD_TINYINT2', 'TINYINT(2)'); // Adjust as needed for your DB
}
if (!defined('OWA_DTD_VARCHAR10')) {
    define('OWA_DTD_VARCHAR10', 'VARCHAR(10)'); // or the appropriate SQL data type
}
if (!defined('OWA_DTD_BOOLEAN')) {
    define('OWA_DTD_BOOLEAN', 'TINYINT(1)'); // or 'BOOLEAN' depending on your DB
}
if (!defined('OWA_DTD_TINYINT')) {
    define('OWA_DTD_TINYINT', 'TINYINT');
}
if (!defined('OWA_DTD_TINYINT4')) {
    define('OWA_DTD_TINYINT4', 'TINYINT(4)');
}
if (!defined('OWA_DTD_SERIAL')) {
